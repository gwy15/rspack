...
fn test_manual_cacheable_dyn_macro_with_generics() {
  ...
  const TYPE_ID_DOG_ANIMAL: u64 = 11;
  ...
  const _: () = {
    ...
    inventory::submit! { DynEntry::new(TYPE_ID_DOG_ANIMAL, get_vtable()) }
  ...
  const TYPE_ID_CAT_ANIMAL: u64 = 12;
  ...
  const _: () = {
    ...
    inventory::submit! { DynEntry::new(TYPE_ID_CAT_ANIMAL, get_vtable()) }
