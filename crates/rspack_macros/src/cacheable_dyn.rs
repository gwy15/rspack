        ...
        const _: () = {
            ...
            impl #ty_generics ArchiveUnsized for dyn #trait_ident #ty_generics {
                ...
                unsafe fn resolve_metadata(
                    ...
                    ArchivedDynMetadata::emplace(#trait_ident::__type_id(self), out);
                }
            }
...
pub fn impl_impl(mut input: ItemImpl) -> TokenStream {
  ...
  quote! {
      const #type_id_ident: std::sync::LazyLock<u64> = std::sync::LazyLock::new(|| {
          rspack_cacheable::r#dyn::dyn_id()
      });
      ...
      const _: () = {
          ...
          inventory::submit! { DynEntry::new(*#type_id_ident, get_vtable()) }
